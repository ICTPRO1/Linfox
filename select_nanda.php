		...
		$output .= <<< UPLOAD
				...
				<tr>
                    <td colspan='2'>
						...
						$(document).on('click', '.delete', function(){
							...
							if(confirm("Are you sure you want to remove this image from database?"))
						  {
						   ...
						   $.ajax({
							...
							method:"POST",
							data:{assets_id:assets_id, action:action},
						...
						<button type="button" class="btn btn-success" style="float: centre;" onclick="encodeImagetoBase64($('#pic'))" >Upload</button>
						<button type="button" name="delete" class="btn btn-danger bt-xs delete" style="float: right;" id="{$_POST["assets_id"]}" >Remove</button>
